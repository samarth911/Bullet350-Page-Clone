...
var cid = document.cookie.match('(^|;)\\s*flag\\s*=\\s*([^;]+)')? "Opt In":"Opt Out";
if (/store/.test(window.location.hostname) || /makeityours/.test(window.location.hostname)) {
    cid = "Opt In";
}
...
SalesforceInteractions.init({
    ...
    const sitemapConfigRE = {
        global: {
            ...
            listeners: [
            	SalesforceInteractions.listener("click", "#customGDPR", () => {
            		const consent = {
            			provider: "Example Consent Manager",
            			purpose: SalesforceInteractions.mcis.ConsentPurpose.Personalization,
        ...
        pageTypes: [
            {
                ...
                contentZones: [
                    ...
                    { 
                        name: "home_page_videoBanner", selector: "#is_hero_banner" 
                    },
                    {
                        name:'slide_popup'
                    }
            ...
            // Added by Hansa Cequity Pvt Ltd
            {
                name: "New Himalayan Teaser Page",
                isMatch: () => /the-final-test/.test(window.location.href),
                interaction: {
                    name: "Viewed New Himalayan Teaser Page",
                },
                listeners: [
                    SalesforceInteractions.listener("click", "#submitForm", () => {
                        console.log('click')
                            SalesforceInteractions.sendEvent({
                              interaction: {
                                name: "Submitted New Himalayan Form",
                              },
                              user: {
                                  identities:{
...

            {
                ...
                new Promise((resolve, reject) => {
                    ...
                    return SalesforceInteractions.DisplayUtils.pageElementLoaded("body","html").then(() => {
                        ...
                        resolve(SalesforceInteractions.cashDom(".catalog-product-view").length > 0);
                    });
                }),
                interaction: {
                    name: SalesforceInteractions.CatalogObjectInteractionName.ViewCatalogObject,
